...
- **JS Interop** - [`extern` declarations](docs/language-guide.md#extern-declarations) for typed JS module contracts, [`Foo.new()`](docs/language-guide.md#constructor-syntax) constructor syntax, `js { }` escape hatch
