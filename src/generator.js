...
export class CodeGenerator {
  ...
  emitRuntimeExtensions() {
    ...
    this.emitLine('wrapped[Symbol.iterator] = function() {');
    this.pushIndent();
    this.emitLine('return {');
    this.pushIndent();
    this.emitLine('next() {');
    this.pushIndent();
    this.emitLine('const value = wrapped();');
    this.emitLine('return value === DONE');
    this.emitLine('  ? { value: undefined, done: true }');
    this.emitLine('  : { value, done: false };');
    this.popIndent();
    this.emitLine('}');
    this.popIndent();
    this.emitLine('};');
